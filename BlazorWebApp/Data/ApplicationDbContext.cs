    ...
    public class ApplicationDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<License>().HasData(
                new License { Id = 1, LicenseKey = "LIC-2025-BASIC-001",  ProgramId = 1, CompanyId = 1,  StartDate = new DateTime(2025, 1, 1),  ExpiryDate = new DateTime(2026, 1, 1),  MaxMembers = 5,  Status = "Active",    CreatedAt = new DateTime(2025, 1, 1)  },
                new License { Id = 2, LicenseKey = "LIC-2025-PRO-002",    ProgramId = 2, CompanyId = 2,  StartDate = new DateTime(2025, 2, 1),  ExpiryDate = new DateTime(2026, 2, 1),  MaxMembers = 10, Status = "Active",    CreatedAt = new DateTime(2025, 2, 1)  },
                new License { Id = 3, LicenseKey = "LIC-2025-ENT-003",    ProgramId = 3, CompanyId = 3,  StartDate = new DateTime(2025, 3, 1),  ExpiryDate = new DateTime(2026, 3, 1),  MaxMembers = 50, Status = "Active",    CreatedAt = new DateTime(2025, 3, 1)  },
                new License { Id = 4, LicenseKey = "LIC-2025-DATA-004",   ProgramId = 4, CompanyId = 4,  StartDate = new DateTime(2025, 4, 1),  ExpiryDate = new DateTime(2026, 4, 1),  MaxMembers = 10, Status = "Active",    CreatedAt = new DateTime(2025, 4, 1)  },
                new License { Id = 5, LicenseKey = "LIC-2025-SEC-005",    ProgramId = 5, CompanyId = 5,  StartDate = new DateTime(2025, 5, 1),  ExpiryDate = new DateTime(2026, 5, 1),  MaxMembers = 5,  Status = "Active",    CreatedAt = new DateTime(2025, 5, 1)  },
                new License { Id = 6, LicenseKey = "LIC-2024-BASIC-006",  ProgramId = 1, CompanyId = 6,  StartDate = new DateTime(2024, 1, 1),  ExpiryDate = new DateTime(2025, 1, 1),  MaxMembers = 5,  Status = "Expired",   CreatedAt = new DateTime(2024, 1, 1)  },
                new License { Id = 7, LicenseKey = "LIC-2025-PRO-007",    ProgramId = 2, CompanyId = 7,  StartDate = new DateTime(2025, 6, 1),  ExpiryDate = new DateTime(2026, 6, 1),  MaxMembers = 10, Status = "Active",    CreatedAt = new DateTime(2025, 6, 1)  },
                new License { Id = 8, LicenseKey = "LIC-2025-ENT-008",    ProgramId = 3, CompanyId = 8,  StartDate = new DateTime(2025, 1, 15), ExpiryDate = new DateTime(2026, 1, 15), MaxMembers = 25, Status = "Suspended", CreatedAt = new DateTime(2025, 1, 15) }
            );

            // ── LicenseMember seed ────────────────────────────────────────────────
            modelBuilder.Entity<LicenseMember>().HasData(
                // License 1 (BasicCRM / TechCorp)
                new LicenseMember { Id = 1,  LicenseId = 1, CustomerId = 1,  AssignedAt = new DateTime(2025, 1, 10) },
                new LicenseMember { Id = 2,  LicenseId = 1, CustomerId = 2,  AssignedAt = new DateTime(2025, 1, 12) },
                // License 2 (ProCRM / InnovateLabs)
                new LicenseMember { Id = 3,  LicenseId = 2, CustomerId = 3,  AssignedAt = new DateTime(2025, 2, 5)  },
                new LicenseMember { Id = 4,  LicenseId = 2, CustomerId = 4,  AssignedAt = new DateTime(2025, 2, 8)  },
                new LicenseMember { Id = 5,  LicenseId = 2, CustomerId = 5,  AssignedAt = new DateTime(2025, 2, 10) },
                // License 3 (EnterpriseCRM / DataSystems)
                new LicenseMember { Id = 6,  LicenseId = 3, CustomerId = 6,  AssignedAt = new DateTime(2025, 3, 5)  },
                new LicenseMember { Id = 7,  LicenseId = 3, CustomerId = 7,  AssignedAt = new DateTime(2025, 3, 6)  },
                new LicenseMember { Id = 8,  LicenseId = 3, CustomerId = 8,  AssignedAt = new DateTime(2025, 3, 7)  },
                new LicenseMember { Id = 9,  LicenseId = 3, CustomerId = 9,  AssignedAt = new DateTime(2025, 3, 8)  },
                // License 4 (DataAnalytics / CloudNext)
                new LicenseMember { Id = 10, LicenseId = 4, CustomerId = 10, AssignedAt = new DateTime(2025, 4, 3)  },
                new LicenseMember { Id = 11, LicenseId = 4, CustomerId = 11, AssignedAt = new DateTime(2025, 4, 5)  },
                // License 5 (SecurityPro / FastTrack)
                new LicenseMember { Id = 12, LicenseId = 5, CustomerId = 12, AssignedAt = new DateTime(2025, 5, 2)  },
                // License 7 (ProCRM / SmartBuild)
                new LicenseMember { Id = 13, LicenseId = 7, CustomerId = 13, AssignedAt = new DateTime(2025, 6, 5)  },
                new LicenseMember { Id = 14, LicenseId = 7, CustomerId = 14, AssignedAt = new DateTime(2025, 6, 7)  },
                // License 8 (EnterpriseCRM / VisionCore)
                new LicenseMember { Id = 15, LicenseId = 8, CustomerId = 15, AssignedAt = new DateTime(2025, 1, 20) },
                new LicenseMember { Id = 16, LicenseId = 8, CustomerId = 16, AssignedAt = new DateTime(2025, 1, 22) },
                new LicenseMember { Id = 17, LicenseId = 8, CustomerId = 17, AssignedAt = new DateTime(2025, 1, 25) }
            );
        }
    }
}
